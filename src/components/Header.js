      ...
      <div className="top-banner" style={{
        ...
        <div className="top-banner-left" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
           ...
           <a href="/pmb" className="btn-daftar-top" style={{ 
             background: '#ffffff', color: '#B91C1C', padding: '6px 16px', borderRadius: '20px', fontSize: '0.75rem', fontWeight: '800', marginLeft: 'auto', transition: 'all 0.3s', textDecoration: 'none', whiteSpace: 'nowrap', flexShrink: 0, boxShadow: '3px 3px 6px rgba(0,0,0,0.15)'
           }} onMouseOver={e=>{e.currentTarget.style.transform='translateY(-2px)'; e.currentTarget.style.boxShadow='4px 4px 10px rgba(0,0,0,0.2)';}} onMouseOut={e=>{e.currentTarget.style.transform='translateY(0)'; e.currentTarget.style.boxShadow='3px 3px 6px rgba(0,0,0,0.15)';}}>
      ...
      <li className="nav-item">
        ...
        <div className="mega-menu portal-mega grid-3 align-right" style={{ gap: '24px' }}>
          ...
          <div>
            ...
            <a href="https://perpustakaan.umiba.ac.id/" target="_blank" className="dropdown-link" style={{ padding: '8px 12px', fontSize: '0.9rem' }}><i className="ph-bold ph-books" style={{ marginRight: '8px' }}></i>{t("nav.perpustakaan")}</a>
