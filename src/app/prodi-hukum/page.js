...
export default function Page() {
  ...
  const heroBg = contents['prodi-hukum_hero_bg'] || 'https://umiba.ac.id/wp-content/uploads/2024/05/bannerUMIBA26_1.png';
  const heroTitle = contents['prodi-hukum_hero_title'] || (lang === "en" ? "Page" : 'S1 Ilmu Hukum');
  const mainHtml = contents['prodi-hukum_html'] || `<!-- ░░░ HERO SUBPAGE ░░░ -->
