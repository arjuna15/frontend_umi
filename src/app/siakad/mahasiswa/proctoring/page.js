      ...
      <div className="fade-in">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', padding: '40px 0' }}>
          <div className="siakad-card" style={{ padding: '40px', width: '100%', maxWidth: '460px', textAlign: 'center' }}>
            ...
            <input id="input-exam-token" type="text" placeholder="Masukkan token ujian..." value={token} onChange={e => setToken(e.target.value.toUpperCase())} onKeyDown={e => e.key === 'Enter' && joinSession()} style={{ width: '100%', padding: '14px 18px', borderRadius: '14px', border: '2px solid var(--color-border)', background: 'var(--color-surface)', color: 'var(--color-text)', fontSize: '1.1rem', outline: 'none', textAlign: 'center', letterSpacing: '0.15em', fontWeight: '700', boxSizing: 'border-box' }} />
