  ...
  return (
    <div>
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ fontSize: '1.8rem', fontWeight: 'bold', color: 'var(--color-text)', margin: '0 0 8px 0' }}>Bimbingan Akademik</h1>
        <p style={{ color: 'var(--color-muted)', margin: 0 }}>Konsultasi rencana studi dan akademik dengan Dosen Wali Anda.</p>
      </div>
