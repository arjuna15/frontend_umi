      ...
      <div className="siakad-card" style={{ padding: '0px', overflow: 'hidden' }}>
        <div style={{ padding: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px', borderBottom: '1px solid var(--color-border)' }}>
          ...
          <div style={{ position: 'relative', width: '300px' }}>
            ...
            <input type="text" className="siakad-input" placeholder="Cari kode, nama prodi, kaprodi..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} style={{ width: '100%', paddingLeft: '46px', color: 'var(--color-text)', fontSize: '0.9rem' }} />
          </div>
        </div>
        ...
        <ModalShell
          ...
          footer={(
            <>
              ...
              <button type="submit" form="prodi-form" className="siakad-btn-primary" style={{ padding: '12px 20px', fontWeight: 700 }}>Simpan</button>
            </>
          )}
        >
