  ...
  return (
    <div className="siakad-page">
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', bottom: '-20px', left: '30%', width: '150px', height: '150px', borderRadius: '50%', background: 'rgba(99,102,241,0.15)', filter: 'blur(30px)' , flexShrink: 0 }}></div>
