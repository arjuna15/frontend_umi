        ...
        >
          ...
          {selectedAttemptDetail ? (
            <div>
              ...
              <p style={{ margin: '0 0 20px 0', color: '#475569', fontSize: '0.85rem' }}>NIM: {selectedAttemptDetail.nim} • Nilai Ujian: <strong style={{ color: '#059669', fontSize: '1.1rem' }}>{selectedAttemptDetail.score}</strong></p>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', fontSize: '0.85rem', flexWrap: 'wrap' }}>
                        <div style={{ padding: '12px', borderRadius: '10px', background: 'rgba(0,0,0,0.02)', border: '1px solid rgba(0,0,0,0.05)' }}>
                          ...
                          {q.type === 'essay' ? (
                            ...
                            <span style={{ fontWeight: '800', color: isCorrect ? '#059669' : '#dc2626', fontSize: '0.9rem' }}>
                      ...
                      {attemptsData
                        ...
                        .map((att, idx) => (
                          <tr key={idx} style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
                            ...
                            <td style={{ padding: '14px 8px' }}>
                              {att.has_attempted ? (
                                <span style={{ display: 'inline-block', background: 'rgba(16,185,129,0.1)', color: '#059669', border: '1px solid rgba(16,185,129,0.2)', padding: '4px 10px', borderRadius: '6px', fontSize: '0.75rem', fontWeight: 'bold' }}>Sudah Mengerjakan</span>
                              ) : (
                                <span style={{ display: 'inline-block', background: 'rgba(0,0,0,0.04)', color: '#64748b', border: '1px solid rgba(0,0,0,0.08)', padding: '4px 10px', borderRadius: '6px', fontSize: '0.75rem', fontWeight: 'bold' }}>Belum Mengerjakan</span>
                              )}
                            </td>
                            <td style={{ padding: '14px 8px', fontWeight: 'bold' }}>
                              {att.has_attempted ? (
                                <span style={{ fontSize: '1rem', color: '#059669' }}>{att.score}</span>
                              ) : (
