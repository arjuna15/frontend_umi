...
export default function Page() {
  ...
  useEffect(() => {
    ...
    fetch(`${api}/contents`)
      .then(res => res.json())
      .then(data => {
        const htmlContent = data.find(c => c.key === 'profil_html');
        const bgContent = data.find(c => c.key === 'profil_hero_bg');
      ...
      .catch(err => console.error('Error fetching content for profil:', err));
  }, []);
...
<div style="position: sticky; top: 100px; z-index: 900; margin-top: 24px; margin-bottom: 24px;">
  <div class="container">
    <div class="profil-neu-card" style="padding: 12px; border-radius: var(--radius-full); display: flex; justify-content: center; gap: 8px; flex-wrap: wrap;">
...
<section id="sejarah" style="padding: var(--space-8) 0;">
  <div class="container">
    <div class="profil-neu-card fade-up">
...
<!-- ░░░ VISI DAN MISI ░░░ -->
<section id="visi-misi" style="padding: var(--space-8) 0; background: var(--color-bg);">
  <div class="container grid grid-2">
    ...
    <div class="profil-neu-card fade-up" style="transition-delay: 0.1s;">
...
<section id="tujuan" style="padding: var(--space-8) 0;">
  <div class="container grid grid-2" style="align-items: center;">
    <div class="profil-neu-card fade-up" style="align-self: start;">
    ...
    <div class="profil-neu-card fade-up" style="transition-delay: 0.2s;" id="sasaran">
...
<!-- ░░░ STRUKTUR ORGANISASI ░░░ -->
<section id="struktur" style="padding: var(--space-8) 0; background: var(--color-bg);">
  <div class="container">
    <div class="profil-neu-card fade-up" style="text-align: center; margin-bottom: 60px;">
    ...
    <div class="profil-neu-card fade-up" style="margin-bottom: 48px;">
      ...
      <div class="grid grid-2" style="gap: 24px; max-width: 1000px; margin: 0 auto; align-items: stretch;">
        <!-- Rektor -->
        <div class="profil-neu-card" style="text-align: center; border-top: 4px solid var(--umiba-red); display: flex; flex-direction: column; justify-content: center; padding: 24px;">
        ...
        <!-- WR 1 -->
        <div class="profil-neu-card" style="text-align: center; display: flex; flex-direction: column; justify-content: center; padding: 24px;">
    ...
    <div class="grid grid-2 fade-up" style="gap: 40px; margin-top: 60px;">
      <div>
        ...
        <ul style="list-style: none; padding: 0;">
          <li class="profil-neu-card" style="margin-bottom: 12px; padding: 16px;">
          ...
          <li class="profil-neu-card" style="padding: 16px;">
      ...
      <div>
        ...
        <div style="margin-top: 32px; text-align: right;">
          <a href="#" class="btn btn-neu">${lang === "en" ? "View Full Chart (PDF)" : "Lihat Bagan Lengkap (PDF)"}</a>
        </div>
      </div>
    </div>
  </div>
...
<!-- ░░░ FASILITAS ░░░ -->
<section id="fasilitas" style="padding: var(--space-8) 0; background: var(--color-bg);">
  <div class="container">
    ...
    <div class="grid grid-3">
      ...
      <div class="profil-neu-card fade-up" style="transition-delay: 0.2s;">
  ...
  return (
    <div className="profil-page">
      <section className="hero hero-sub profil-hero">
      ...
      <div className="profil-content" dangerouslySetInnerHTML={{ __html: dynamicHtml || mainHtml }} />
    </div>
  );
}
