...
export default function Page() {
  ...
  const heroBg = contents['prodi-manajemen_hero_bg'] || 'https://umiba.ac.id/wp-content/uploads/2024/05/bannerUMIBA26_2.png';
  const heroTitle = contents['prodi-manajemen_hero_title'] || (lang === "en" ? "Page" : 'S1 Manajemen');
  const mainHtml = contents['prodi-manajemen_html'] || `<!-- ░░░ HERO SUBPAGE ░░░ -->
