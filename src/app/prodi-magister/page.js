...
export default function Page() {
  ...
  const heroBg = contents['prodi-magister_hero_bg'] || 'https://umiba.ac.id/wp-content/uploads/2024/05/bannerUMIBA26_2.png';
  const heroTitle = contents['prodi-magister_hero_title'] || (lang === "en" ? "Page" : 'S2 Magister Manajemen');
  const mainHtml = contents['prodi-magister_html'] || `<!-- ░░░ HERO SUBPAGE ░░░ -->
