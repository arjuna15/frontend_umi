...
export default function BeritaPage() {
  ...
  return (
    <>
      {/* ░░░ HERO SUBPAGE ░░░ */}
      <section className="hero hero-sub" style={{ background: "url('https://umiba.ac.id/wp-content/uploads/2024/05/bannerUMIBA26_2.png') center/cover", position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', color: 'white', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'sticky', top: '100px', zIndex: '900', marginTop: '24px', marginBottom: '24px' }}>
        <div className="container">
          <div className="neu-card" style={{ background: "var(--glass-bg)", boxShadow: "var(--glass-shadow)", border: "none", borderRadius: "16px", padding: '12px', borderRadius: 'var(--radius-full)', display: 'flex', justifyContent: 'center', gap: '8px', flexWrap: 'wrap' }}>
            ...
            <div className="grid grid-3">
              {newsData.length > 0 ? (
                newsData.map((item, index) => (
                  <div key={item.id} className="neu-card fade-up" style={{ background: "var(--glass-bg)", boxShadow: "var(--glass-shadow)", border: "none", borderRadius: "16px", transitionDelay: `${index * 0.1}s` }}>
