          ...
          <div className="hero-model-container" style={{ position: 'absolute', right: '0', bottom: 0, height: '100%', width: '45%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', pointerEvents: 'none', zIndex: 1 }}>
            <div style={{ position: 'relative', width: '380px', height: '380px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginRight: '40px', marginTop: '-40px' }}>
              ...
              <div style={{ position: 'absolute', inset: '-20px -20px 0 -20px', zIndex: 1 }}>
                <Image src="/nobcg1.png" alt="Student Model 1" fill style={{ objectFit: 'contain', objectPosition: 'bottom center' }} priority />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', position: 'relative', zIndex: 2, height: '100%' }}>
          ...
          <div className="hero-model-container" style={{ position: 'absolute', right: '0', bottom: 0, height: '100%', width: '45%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', pointerEvents: 'none', zIndex: 1 }}>
            <div style={{ position: 'relative', width: '380px', height: '380px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginRight: '40px', marginTop: '-40px' }}>
              ...
              <div className="avatar-circle-bg" style={{ position: 'absolute', inset: 0, borderRadius: '50%', background: 'var(--liquid-bg)', boxShadow: 'inset 8px 8px 16px var(--inset-shadow-dark), inset -8px -8px 16px var(--inset-shadow-light), 4px 4px 12px rgba(0,0,0,0.05)', zIndex: 0 }}></div>
              <div style={{ position: 'absolute', inset: '-20px -20px 0 -20px', zIndex: 1 }}>
                <Image src="/nobcg2.png" alt="Student Model 2" fill style={{ objectFit: 'contain', objectPosition: 'bottom center' }} priority />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', position: 'relative', zIndex: 2, height: '100%' }}>
          ...
          <div className="hero-model-container" style={{ position: 'absolute', right: '0', bottom: 0, height: '100%', width: '45%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', pointerEvents: 'none', zIndex: 1 }}>
            <div style={{ position: 'relative', width: '380px', height: '380px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginRight: '40px', marginTop: '-40px' }}>
              ...
              <div className="avatar-circle-bg" style={{ position: 'absolute', inset: 0, borderRadius: '50%', background: 'var(--liquid-bg)', boxShadow: 'inset 8px 8px 16px var(--inset-shadow-dark), inset -8px -8px 16px var(--inset-shadow-light), 4px 4px 12px rgba(0,0,0,0.05)', zIndex: 0 }}></div>
              <div style={{ position: 'absolute', inset: '-20px -20px 0 -20px', zIndex: 1 }}>
                <Image src="/nobcg3.png" alt="Student Model 3" fill style={{ objectFit: 'contain', objectPosition: 'bottom center' }} priority />
              </div>
            </div>
          </div>
        </div>
