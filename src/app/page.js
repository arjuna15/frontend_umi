...
<section id="beranda" style={{ width: '100%', minHeight: 'calc(100vh - 54px)', position: 'relative', margin: 0, padding: 0 }}>
  <div style={{ position: 'relative', width: '100%', minHeight: 'calc(100vh - 54px)' }}>
    
    {/*  Slider Backgrounds & Contents  */}
    <div id="heroSlides" style={{ display: 'grid', width: '100%', minHeight: 'calc(100vh - 54px)', zIndex: '-2' }}>
      
      {/* SLIDE 1: Magister Manajemen */}
      <div className={`hero-slide hero-content-padding ${currentSlide === 0 ? 'active' : ''}`} style={{ backgroundImage: `url('/1.jpeg')`, opacity: currentSlide === 0 ? 1 : 0, pointerEvents: currentSlide === 0 ? 'auto' : 'none', zIndex: currentSlide === 0 ? 10 : 1, display: 'flex' }}>
      ...
      {/* SLIDE 2: KIP-K */}
      <div className={`hero-slide hero-content-padding ${currentSlide === 1 ? 'active' : ''}`} style={{ backgroundImage: `url('/2.jpeg')`, opacity: currentSlide === 1 ? 1 : 0, pointerEvents: currentSlide === 1 ? 'auto' : 'none', zIndex: currentSlide === 1 ? 10 : 1, display: 'flex' }}>
        <div className="hero-overlay-red" style={{ position: 'absolute', inset: 0, zIndex: 1 }}></div>
      ...
      <div className={`hero-slide hero-content-padding ${currentSlide === 2 ? 'active' : ''}`} style={{ backgroundImage: `url('/3.jpeg')`, opacity: currentSlide === 2 ? 1 : 0, pointerEvents: currentSlide === 2 ? 'auto' : 'none', zIndex: currentSlide === 2 ? 10 : 1, display: 'flex' }}>
        <div className="hero-overlay-red" style={{ position: 'absolute', inset: 0, zIndex: 1 }}></div>
